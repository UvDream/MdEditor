...
export async function putUserUserConfig(body: API.UserConfig, options?: { [key: string]: any }) {
...
export async function postUserUserConfig(body: API.UserConfig, options?: { [key: string]: any }) {
  return request<string>('/user/user_config', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
