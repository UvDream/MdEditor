...
export async function postLedgerBillCreate(body: API.Bill, options?: { [key: string]: any }) {
    return request<API.Response & { code?: number; data?: API.Bill; msg?: string; success?: boolean }>('/ledger/bill/create', {
        method: 'POST',
        headers: {
...
export async function getLedgerBillList(options?: { [key: string]: any }) {
    return request<API.Response & { code?: number; data?: API.Bill[]; msg?: string; success?: boolean }>('/ledger/bill/list', {
        method: 'GET',
        ...(options || {}),
    });
}
...
export async function putLedgerBillUpdate(body: API.Bill, options?: { [key: string]: any }) {
    return request<API.Response & { code?: number; data?: API.Bill; msg?: string; success?: boolean }>('/ledger/bill/update', {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
        },
...
export async function postLedgerCategoryCreate(
    ...
    return request<API.Response & { code?: number; data?: API.LedgerCategory; msg?: string; success?: boolean }>('/ledger/category/create', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
export async function getLedgerCategoryList(
    ...
    return request<API.Response & { code?: number; data?: API.LedgerCategory[]; msg?: string; success?: boolean }>('/ledger/category/list', {
        method: 'GET',
        params: {
            ...params,
        },
...
export async function putLedgerCategoryUpdate(
    ...
    return request<API.Response & { code?: number; data?: API.LedgerCategory; msg?: string; success?: boolean }>('/ledger/category/update', {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
        },
...
export async function postLedgerTagCreate(body: API.LedgerTag, options?: { [key: string]: any }) {
    return request<API.Response & { code?: number; data?: API.LedgerTag; msg?: string; success?: boolean }>('/ledger/tag/create', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
export async function getLedgerTagList(options?: { [key: string]: any }) {
    return request<API.Response & { code?: number; data?: API.LedgerTag[]; msg?: string; success?: boolean }>('/ledger/tag/list', {
        method: 'GET',
        ...(options || {}),
    });
}
...
export async function putLedgerTagUpdate(body: API.LedgerTag, options?: { [key: string]: any }) {
    return request<API.Response & { code?: number; data?: API.LedgerTag; msg?: string; success?: boolean }>('/ledger/tag/update', {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
        },
